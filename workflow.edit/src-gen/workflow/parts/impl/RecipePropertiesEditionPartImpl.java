 ...
 * 
 */
public class RecipePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RecipePropertiesEditionPart {
	 ...
	 * 
	 */
	public RecipePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(WorkflowMessages.RecipePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(WorkflowViewsRepository.Recipe.Properties.name, WorkflowViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommandsAdvancedTableComposition(Composite parent) {
		this.commands = new ReferencesTable(getDescription(WorkflowViewsRepository.Recipe.Properties.commands, WorkflowMessages.RecipePropertiesEditionPart_CommandsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				commands.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				commands.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				commands.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.commands, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				commands.refresh();
			}
		...
		this.commands.setHelpText(propertiesEditionComponent.getHelpContent(WorkflowViewsRepository.Recipe.Properties.commands, WorkflowViewsRepository.SWT_KIND));
		this.commands.createControls(parent);
		this.commands.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipePropertiesEditionPartImpl.this, WorkflowViewsRepository.Recipe.Properties.commands, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
