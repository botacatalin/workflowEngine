...
/**
 * This is the item provider adapter for a {@link workflow.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
	...
	/**
	 * This adds a property descriptor for the Name exec feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addName_execPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_name_exec_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_name_exec_feature", "_UI_Program_type"),
				 WorkflowPackage.Literals.PROGRAM__NAME_EXEC,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_description_feature", "_UI_Program_type"),
				 WorkflowPackage.Literals.PROGRAM__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.PROGRAM__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Program)object).getName_exec();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.PROGRAM__PARAMETERS,
				 WorkflowFactory.eINSTANCE.createInputParameter()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.PROGRAM__PARAMETERS,
				 WorkflowFactory.eINSTANCE.createOutputParameter()));
	}
