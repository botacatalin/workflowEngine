...
public class WorkflowItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.WORKFLOW__RECIPES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Workflow.class)) {
			case WorkflowPackage.WORKFLOW__NAME:
				...
				return;
			case WorkflowPackage.WORKFLOW__RECIPES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__RECIPES,
				 WorkflowFactory.eINSTANCE.createRecipe()));
	}
