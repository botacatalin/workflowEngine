 ...
 *   <li>{@link workflow.impl.WorkflowImpl#getRecipe <em>Recipe</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowImpl extends MinimalEObjectImpl.Container implements Workflow {
	...
	public EList<Recipe> getRecipe() {
		if (recipe == null) {
			recipe = new EObjectContainmentEList<Recipe>(Recipe.class, this, WorkflowPackage.WORKFLOW__RECIPE);
		}
		return recipe;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WorkflowPackage.WORKFLOW__RECIPE:
