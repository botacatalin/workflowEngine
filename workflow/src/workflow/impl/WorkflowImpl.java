 ...
 *   <li>{@link workflow.impl.WorkflowImpl#getRecipes <em>Recipes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowImpl extends MinimalEObjectImpl.Container implements Workflow {
	...
	public EList<Recipe> getRecipes() {
		if (recipes == null) {
			recipes = new EObjectContainmentEList<Recipe>(Recipe.class, this, WorkflowPackage.WORKFLOW__RECIPES);
		}
		return recipes;
	}
