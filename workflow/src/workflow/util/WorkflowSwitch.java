...
public class WorkflowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkflowPackage.SIMPLE_COMMAND: {
				SimpleCommand simpleCommand = (SimpleCommand)theEObject;
				T result = caseSimpleCommand(simpleCommand);
				if (result == null) result = caseStatement(simpleCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkflowPackage.INPUT_PARAMETER: {
			...
			case WorkflowPackage.OUTPUT_PARAMETER: {
