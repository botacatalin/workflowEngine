 ...
 * 
 */
public class WorkflowEditorMessages extends NLS {
	
	private static final String BUNDLE_NAME = "workflow.providers.workflowEditorMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, WorkflowEditorMessages.class);
	}

	
	private WorkflowEditorMessages() {
